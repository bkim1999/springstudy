...
INSERT INTO USER_T VALUES(USER_SEQ.NEXTVAL, '해린@gmail.com', (SELECT SHA256('1111') FROM DUAL), '강해린', 'F', '01011111111', '11111', '뉴진스로', '뉴진스동', '뉴진스호', 0, 0, SYSDATE, SYSDATE);
...
CREATE TABLE BLOG_T (
    ...
    CONSTRAINT FK_BLOG_USER FOREIGN KEY(USER_NO) REFERENCES USER_T(USER_NO) ON SET NULL
);
